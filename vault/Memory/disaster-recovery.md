 ...
 **FIX IN PROGRESS (2026-07-22):** a KeePassXC secrets vault ([[secrets-vault]]) will hold the signing key + all secrets, synced NAS+local+offsite — attach the .jks + get the vault offsite and this SPOF is closed.
