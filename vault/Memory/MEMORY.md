...
- [GPU box](gpu-box.md) — RTX 5060 Ti desktop (separate from ikedev iGPU laptop) for vision + heavier local LLM; Blackwell needs driver 570+; setup runbook in deploy/gpu-box
