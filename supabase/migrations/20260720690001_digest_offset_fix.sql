-- Digest fix: weekly_flash offsets go FORWARD for positive values — the
-- Monday digest wants the week that just CLOSED, i.e. offset -1. Caught by
-- running the first digest live (it summarized a 1-day-old week of zeros).
