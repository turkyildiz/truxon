-- R9 #109 sentinel: document index freshness. The hourly NAS index cron
-- (run-index.sh, :40) embeds new docs; if NOTHING has been indexed for 26h+
-- while unindexed docs exist, the pipeline is dead and doc search is silently
-- going stale. Mirrors the backup_fresh heartbeat philosophy: absence of
-- evidence IS the alarm.
-- Lineage: full body from 20260723150007 (previous head) + ONE new block.
