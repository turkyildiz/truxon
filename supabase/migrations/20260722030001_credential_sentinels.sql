-- R9 #13-15/#24: medical-card fields + credential expiry sentinels (CDL,
-- medical card, plates; 60/30/7-day escalation). Full sentinel_scan
-- redefinition (latest = 20260722024001, toll double-charge).
