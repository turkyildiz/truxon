-- Hotfix: sliver_aging finding used null entity_type (NOT NULL column) —
-- the whole scan would abort. Company-wide findings use ''. Full corrected
-- redefinition (lineage: this file supersedes 038001).
