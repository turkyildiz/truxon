-- Sentinel: factoring reserve-stuck finding. Flags invoices factored 45+
-- days ago whose reserve the factor still hasn't released (critical at
-- 75d) — money sitting at Denim that nobody was watching. Body is the
-- prior sentinel_scan (factoring_ar_sweep) with the one block added.
