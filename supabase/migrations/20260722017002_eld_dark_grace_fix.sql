-- R8 Block 13b - eld_dark grace fix. Full sentinel_scan redefinition
-- (latest = 20260722016002 with the corrected grace predicate). First live
-- run fired NOTHING: every truck row was created on the 2026-07-16 bulk
-- import, so the created_at-based 7-day grace covered the whole fleet.
