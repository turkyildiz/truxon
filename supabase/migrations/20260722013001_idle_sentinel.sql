-- R8 Block 2 - chronic-idler sentinel. Full sentinel_scan redefinition
-- (latest = 20260722010001 + spliced idle check). idle_summary() already
-- time-weights STATIONARY vs IN_MOTION breadcrumbs with the 15-min-gap
-- engine-off cap; this turns its per-truck breakdown into a standing finding.
