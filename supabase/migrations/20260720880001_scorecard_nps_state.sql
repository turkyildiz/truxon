-- R4 exam fix round 2 — Forest read the scorecard's driver_nps: null as
-- "instrument not live". The empty state now says exactly what is true:
-- the survey is live, responses just haven't arrived. Whole function
-- reproduced from 20260720870001.
