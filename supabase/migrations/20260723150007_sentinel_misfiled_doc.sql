-- R9 #102 sentinel: doc filed under one label but the classifier reads it as
-- another — a misfiled POD/rate-con corrupts retention stats and doc search.
-- Lineage: full body from 20260723150003 (previous head) + ONE new block.
