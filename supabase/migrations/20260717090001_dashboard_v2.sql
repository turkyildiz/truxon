-- Dashboard v2: richer summary for the redesigned dashboard.
-- Adds week-over-week comparison, 12-week / 12-month trend series,
-- top customers (90 days) and driver performance (30 days).
