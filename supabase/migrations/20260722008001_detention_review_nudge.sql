-- Detention nudge (R6 block 1): the propose→approve pipeline only pays if
-- someone clicks. This makes the aging review queue nag from the feed.
-- Full sentinel_scan redefinition (latest = 20260722002003) + one new check.
