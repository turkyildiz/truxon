-- R9 #58: dark-ELD escalation ladder. Past two weeks the finding's title
-- bumps weekly ('STILL dark - week N') so the daily brief re-surfaces it —
-- unit 05 has been dark since January and had become wallpaper. Full
-- sentinel_scan redefinition (latest = 20260722048002).
