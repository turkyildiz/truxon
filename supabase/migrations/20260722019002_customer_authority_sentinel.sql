-- R8 Blocks 31/32b - customer-authority sentinel. Full sentinel_scan
-- redefinition (latest = 20260722017002 + spliced checks over
-- customer_fmcsa_checks, fed by fmcsa-watch's weekly 'customers' sweep).
