-- R4 drift-exam fix — company_scorecard's net/OR/net-margin now anchor to
-- the GL when it covers the window (whole function reproduced from
-- 20260720880001). The operational direct-cost fields stay for the per-mile
-- detail; margin_basis says which source produced the headline ratios.
